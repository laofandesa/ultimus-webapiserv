...
{
    public partial class TccInvoicesRendered
    {
        ...
        public decimal? Sbclchk { get; set; }
        public decimal? Sjk { get; set; }
        public decimal? Zxjfw { get; set; }
        public string ApplyRateCode { get; set; }
        public string ApplyRateText { get; set; }
        public string RateMethodYn { get; set; }
        public decimal? DiffAdvanceTax { get; set; }
        public decimal? AmountDeducted { get; set; }
        public DateTime? ApprovalDate { get; set; }
        public string TaxationStart { get; set; }
        public string TaxationEnd { get; set; }
        public decimal? TaxDues { get; set; }
        public int? LinkedIncident { get; set; }
        public decimal? LinkedOtherCost { get; set; }
    }
}
