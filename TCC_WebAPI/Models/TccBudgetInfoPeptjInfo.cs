...
{
    public partial class TccBudgetInfoPeptjInfo
    {
        ...
        public string ProjBdate { get; set; }
        public string ProjEdate { get; set; }
        public decimal? TotalHours { get; set; }
        public decimal? HappenHours { get; set; }
        public decimal? PlantHours { get; set; }
        public decimal? PlantFee { get; set; }
        public decimal? PlannedInvestment { get; set; }
        public decimal? HappenMoney { get; set; }
        public decimal? YearsTotalPlannedInvestment { get; set; }
