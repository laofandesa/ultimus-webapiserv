...
{
    public partial class TccGeneralExpensesHeader
    {
        ...
        public int? IsTaxReimbursement { get; set; }
        public int? IsCj { get; set; }
        public string IsForeignBank { get; set; }
        public string ActPayCurrency { get; set; }
        public string ActPayCurrencyName { get; set; }
        public decimal? ActPayAmount { get; set; }
        public decimal? ActPayRate { get; set; }
